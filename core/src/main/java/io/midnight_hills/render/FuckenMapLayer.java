...
public class FuckenMapLayer extends Renderable{
    private MapLayer layer;
    private OrthographicCamera camera;
    static protected final int NUM_VERTICES = 20;
    protected float[] vertices = new float[NUM_VERTICES];

    public FuckenMapLayer(Camera gameCamera, float depth, MapLayer layer, String shader){
    ...
    public void render(SpriteBatch batch) {
        ...
        renderTileLayer((TiledMapTileLayer) layer, batch);
    }
    ...
    public void renderTileLayer (TiledMapTileLayer layer, SpriteBatch batch) {
        final Color batchColor = batch.getColor();
        final float color = getTileLayerColor(layer, batchColor);
        final float unitScale = 1.0f;
